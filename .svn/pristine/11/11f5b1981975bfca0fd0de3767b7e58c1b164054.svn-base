		...
		<div class="card-body">
			<div>
				<form name="searchForm" id="searchForm"
					...
					action="/community/list?keyWord=${param.keyWord}" method="get">
					...
					<tbody>
						<c:forEach var="vo" items="${list}">
							<tr>
								<td>${vo.rnum}</td>
								<td><a
									href="/community/detail?brdId=${vo.brdId}&currentPage=${page.currentPage}">${vo.brdTitle}</a></td>
								<td>${vo.brdWrtr}</td>
...
<%-- 				<sec:authorize access="hasRole('ROLE_ADMIN')"> --%>
					<a href="/community/insert" class="mb-2 btn btn-md btn-success mr-3"
				...
				<div class="col-lg-12 offset-lg-4 py-5 ">
					<ul class="pagination" style="width: 320px;">
						...
						<li
							...
							href="/community/list?currentPage=${page.startPage-page.pagingCount}&keyWord=${param.keyWord}"
						...
						<c:forEach var="pNo" begin="${page.startPage}"
							...
							<li
								...
								href="/community/list?currentPage=${pNo}&keyWord=${param.keyWord}"
