                ...
                <div class="p-4">
                    <div class="card overflow-hidden mt-2">
                        <div class="auth-logo text-center bg-primary position-relative">
                            ...
                            <p class="text-white-50 mb-0">Sign in to continue to Medroc.</p>
                            </div>
                        </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <p>© <script>document.write(new Date().getFullYear())</script>2022 Medroc. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesdesign</p>
                    </div>
                </div>
                </div>
            </div>
