...
<div class="container-fluid">
	...
	<div class="col-12">
		<div
			...
			<a href="/community/list"><h2>자유게시판</h2></a>
		</div>
	</div>
	<div class="card">
		<div class="card-body">
		...
		<div class="card">
			<div class="card-body">
				<form:form modelAttribute="boardReplyVO" method="post"
					action="/community/rinsert?brdId=${boardReplyVO.brdId}&currentPage=${currentPage}">
...
<!-- 						<input type="hidden" name="brdRcvId" value="11">; -->
				...
				<div class="col-lg-12">
					<table width="100%">
						<tr id="rupdateFormTr">
							<td colspan="3">
								<form action="/community/rupdate" method="post" id="rupdateForm"
									style="display: none;">
									<sec:csrfInput />
	...
	<%-- 								<sec:authentication property="principal.user.empName"/> --%>
									...
									<c:if test="${boardReplyVO.brdRplyWrtr == userName}">
										<a
											href="/community/rdelete?brdId=${boardReplyVO.brdId}&brdRplyId=${boardReplyVO.brdRplyId}&currentPage=${currentPage}"
											id="btnRDelete"
	...
	<div class="col-lg-12 py-5" align="right">
		...
		<c:if test="${boardVO.brdWrtr == userName}">
			<a href="/community/delete?brdId=${param.brdId}" id="btnDelete"
				class="btn btn-secondary btn-icon-split">삭제</a>
			<a href="/community/update?brdId=${param.brdId}" id="btnEdit"
		...
		<a href="/community/list?currentPage=${currentPage}"
