...
<script type="text/javascript">
	...
	function deletechoiceMail(){
		...
		$.ajax({
			url : "/email/deleteunsentChoice",
			data : {delUnsentArr : delMail},
			type : "get",
			success : function(data){
				if(data=="success"){
					location.href = "/email/unsentMailBox";
				}else{
					alert("메일 삭제 실패");
				}
			},
...
<h2 class="m-0 font-weight-bold text-primary" >임시보관함
    ...
    <div class="card-body" style="height: 80vh;">
        <div class="table-responsive">
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
            	<!-- 검색하는 부분  시작-->
		            <form name="searchForm" id="searchForm" action="/email/unsentMailBox" method="get">
		            <label>Search:
            ...
            <table style="text-align: center;" class="table table-bordered dataTable table-striped" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                ...
                <c:forEach var="row" items="${list}" varStatus="status">
               	<tr>
                    ...
                    <td style="text-align:left;"><a href="/email/unsentMailDetail?emailId=${row.emailId}">${row.emailTitle}</a></td>
            ...
            <!-- 페이징 처리 시작 -->
				<ul class="pagination">
					...
					<li
						...
						<a href="/email/unsentMailBox?currentPage=${page.startPage-page.pagingCount}&keyWord=${param.keyWord}"
					...
					<c:forEach var="pNo" begin="${page.startPage}" end="${page.endPage}"
						...
						<li
							...
							<a href="/email/unsentMailBox?currentPage=${pNo}&keyWord=${param.keyWord}"
					...
					<li
						...
						id="dataTable_next"><a
						href="/email/unsentMailBox?currentPage=${page.startPage+page.pagingCount}&keyWord=${param.keyWord}"
