...
<h2 class="m-0 font-weight-bold text-primary" >받은메일함
        ...
        <div class="table-responsive">
            ...
            <table style="text-align: center;" class="table table-bordered dataTable table-striped" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                ...
                <tr role="row" >
                    ...
                    <th tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 200px;">발신자&nbsp;&nbsp;ID&nbsp;&nbsp;|&nbsp;&nbsp;이름</th>
                    <th tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending">제목</th>
                    <th style="width: 250px;">메일수신일자</th>
                    <th style="width: 150px;">확인여부</th>
                </tr>
                </thead>
                ...
                <c:forEach var="row" items="${list}" varStatus="status">
               	<tr>
                    ...
                    <td  style="text-align:left;"><a href="/email/reMailDetail?emailId=${row.emailId}">${row.emailTitle}</a></td>
                    <td><fmt:formatDate value="${row.emailWrtDt}"  pattern="yyyy-MM-dd  hh:mm"/></td>
					<td>${row.emailCheck }</td>
                </tr>
                </c:forEach>
                </tbody>
            </table>
