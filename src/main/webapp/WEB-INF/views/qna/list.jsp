		...
		<div class="card-body">
			<div>
				<form name="searchForm" id="searchForm"
					...
					action="/qna/list?keyWord=${param.keyWord}" method="get">
					...
					<tbody>
						<c:forEach var="vo" items="${list}">
							<tr>
								...
								<td><a
									href="/qna/detail?brdId=${vo.brdId }&currentPage=${page.currentPage}">${vo.brdTitle }</a></td>
				...
				<br> <br> <a href="/qna/insert"
					class="mb-2 btn btn-md btn-success mr-3" style="float: right;">등록</a>
				<br>
				<!-- 페이징 처리 시작 -->
				<div class="col-lg-12 offset-lg-4 py-5 ">
					<ul class="pagination" style="width: 320px;">
						...
						<li
							...
							href="/qna/list?currentPage=${page.startPage-page.pagingCount}&keyWord=${param.keyWord}"
						...
						<c:forEach var="pNo" begin="${page.startPage}"
							...
							<li
								...
								href="/qna/list?currentPage=${pNo}&keyWord=${param.keyWord}"
