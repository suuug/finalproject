package kr.or.workTogether.project.mapper;
...
public interface ProjectMapper {
	...
	// 업무 담당자 추가
	public int insertMngr(List<WorkMngrVO> workMngrVOList) throws Exception;
	...
	// 업무 담당자 삭제
	public void deleteMngr(String workId);
	
	// 업무 담당자 업데이트
	public int updateMngr(List<WorkMngrVO> workMngrVO);
